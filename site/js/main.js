  ...
  if (nlForm) {
    nlForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (window.gtag) gtag("event", "form_submit", { form_type: "newsletter" });
      ...
      fr: [
        {
          name: "Isia",
          role: "Scène & shows",
          bio: "Un regard qui capte la salle entière. Isia impose le silence avant même le premier pas.",
        },
        {
          name: "Lila",
          role: "Scène & soirées",
          bio: "Sous les lumières violettes, Lila fait de la scène son territoire. Présence magnétique, énergie contagieuse.",
        },
        {
          name: "Luna",
          role: "Salons privés",
          bio: "Douceur et malice. Luna installe une intimité complice, où le temps semble ralentir.",
        },
        {
          name: "Maya",
          role: "Pole dance",
          bio: "À la barre, Maya joue avec la gravité. Des lignes nettes, une maîtrise qui force le regard.",
        },
        {
          name: "Melody",
          role: "Table dance & shows",
          bio: "Élégance en dentelle et gestes précis. Melody transforme chaque danse en confidence.",
        },
      ],
      en: [
        {
          name: "Isia",
          role: "Stage & shows",
          bio: "A gaze that holds the whole room. Isia commands silence before she has even taken a step.",
        },
        {
          name: "Lila",
          role: "Stage & club nights",
          bio: "Under the violet lights, Lila makes the stage her own. Magnetic presence, contagious energy.",
        },
        {
          name: "Luna",
          role: "Private rooms",
          bio: "Softness and mischief. Luna creates a knowing intimacy where time seems to slow down.",
        },
        {
          name: "Maya",
          role: "Pole dance",
          bio: "On the pole, Maya plays with gravity. Clean lines and a command that holds every eye.",
        },
        {
          name: "Melody",
          role: "Table dance & shows",
          bio: "Lace elegance and precise movement. Melody turns every dance into a confidence.",
        },
      ],
      es: [
        {
          name: "Isia",
          role: "Escenario y shows",
          bio: "Una mirada que atrapa a toda la sala. Isia impone el silencio antes incluso del primer paso.",
        },
        {
          name: "Lila",
          role: "Escenario y noches del club",
          bio: "Bajo las luces violetas, Lila hace suyo el escenario. Presencia magnética, energía contagiosa.",
        },
        {
          name: "Luna",
          role: "Salones privados",
          bio: "Dulzura y picardía. Luna crea una intimidad cómplice en la que el tiempo parece ralentizarse.",
        },
        {
          name: "Maya",
          role: "Pole dance",
          bio: "En la barra, Maya juega con la gravedad. Líneas limpias y un dominio que atrapa la mirada.",
        },
        {
          name: "Melody",
          role: "Table dance y shows",
          bio: "Elegancia de encaje y gestos precisos. Melody convierte cada baile en una confidencia.",
        },
      ],
    };
    const DANCERS =
  ...
  document.querySelectorAll(".page-form").forEach((form) => {
    form.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (window.gtag) gtag("event", "form_submit", { form_type: form.dataset.form });
